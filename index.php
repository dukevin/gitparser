...
<form action="scrape.php" method="get" target="_blank">
	<p>Supports googlesource and gerrit url</p>
	...
	<input type="text" name="q" id="q" placeholder="query" value="<?=empty($_REQUEST["q"]) ? "changes" : $_REQUEST["q"] ?>" placeholder="changes" size=8/></div><br clear='both'>
